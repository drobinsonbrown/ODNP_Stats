...
writeFreqTimeShort = 100 # Write to trajectory file every 0.01 ps
...
simulation.loadState('state10.xml')
...
simulation.reporters.append(app.dcdreporter.DCDReporter('nve_production_output_wrapped10_short.dcd', writeFreqTimeShort, enforcePeriodicBox=True))
	
simulation.step(int(1000*ps))

### (insert other dynamics)
#trajName = 'nve_production_output_wrapped10_short.dcd'
